    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apdate', models.DateTimeField(auto_now_add=True, verbose_name='обновлён')),
                ('status', models.CharField(choices=[('FRM', 'формируется'), ('STP', 'отправлен в обработку'), ('PD', 'оплачено'), ('RDY', 'готово к выдаче'), ('CNC', 'отмена заказа')], default='FRM', max_length=3, verbose_name='статус')),
